      ...
      {showOptions ? 
        (
          <div className="absolute top-16 rounded-md border border-gray-300">
            ...
            <div onClick={SingOut} className="w-full flex items-center justify-start gap-2 px-4 hover:bg-sky-100 rounded-lg">
